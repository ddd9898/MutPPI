...
if __name__ == '__main__':
    ...
    #Output name
    add_name = '_100CV{}-Train-S645_ReductionMode{}-{}_RandomSeed-{}'.format(args.fold, REDUCTION_MODE, args.reduction, args.randomseed)
    #
    ...
    traindataset = StructureGraphDataset(datapath='./data/Graphinity/Experimental_ddG_645_+Reverse_Mutations_+Non_Binders/Experimental_ddG_645_+Reverse_Mutations_+Non_Binders-cutoff_100-10foldcv_fixed.csv', train_flag = True, fold = args.fold, reduction=args.reduction, reduction_mode=REDUCTION_MODE)
    testdataset  = StructureGraphDataset(datapath='./data/Graphinity/Experimental_ddG_645_+Reverse_Mutations_+Non_Binders/Experimental_ddG_645_+Reverse_Mutations_+Non_Binders-cutoff_100-10foldcv_fixed.csv', train_flag = False, fold = args.fold, reduction=args.reduction, reduction_mode=REDUCTION_MODE)
